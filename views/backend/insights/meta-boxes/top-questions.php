<ul class="urtak-tabbed-control" id="urtak-questions-tabbed-control">
	...
	<li><a href="#urtak-cared-questions"><?php _e('Most Cared', 'urtak'); ?></a></li>
	<li><a href="#urtak-agreed-questions"><?php _e('Most Agreed', 'urtak'); ?></a></li>
</ul>
...
<div id="urtak-divided-questions" data-tabbed-depend-on="urtak-questions-tabbed-control">
	...
	<div id="setting-error-settings_updated" class="settings-error error">
		<p><?php _e('Your publication\'s most cared divided questions could not be retrieved.', 'urtak'); ?></p>
	</div>
	<?php } else if(empty($most_divided)) { ?>
	<div id="setting-error-settings_updated" class="settings-error error">
		<p><?php _e('You don\'t have any divided questions.', 'urtak'); ?></p>
	</div>
	<?php } else { ?>
...
<div id="urtak-cared-questions" data-tabbed-depend-on="urtak-questions-tabbed-control">
	...
	<div id="setting-error-settings_updated" class="settings-error error">
		<p><?php _e('Your publication\'s most cared about questions could not be retrieved.', 'urtak'); ?></p>
	</div>
	<?php } else if(empty($most_cared)) { ?>
	<div id="setting-error-settings_updated" class="settings-error error">
		<p><?php _e('You don\'t have any cared about questions.', 'urtak'); ?></p>
	</div>
	<?php } else { ?>
...
<div id="urtak-agreed-questions" data-tabbed-depend-on="urtak-questions-tabbed-control">
	...
	<div id="setting-error-settings_updated" class="settings-error error">
		<p><?php _e('Your publication\'s most cared upon questions could not be retrieved.', 'urtak'); ?></p>
	</div>
	<?php } else if(empty($most_agreed)) { ?>
	<div id="setting-error-settings_updated" class="settings-error error">
		<p><?php _e('You don\'t have any agreed on questions.', 'urtak'); ?></p>
	</div>
	<?php } else { ?>
