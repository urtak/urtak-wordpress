...
<script src="https://dev-tunnel.urtak.com/assets/clr.js" type='text/javascript'></script>
<div data-publication-key = '<?php esc_attr_e($publication_key); ?>'
	 data-post-title      = '<?php esc_attr_e($title); ?>'
	 data-post-permalink  = '<?php esc_attr_e($permalink); ?>'
	 data-post-id         = '<?php esc_attr_e($post_id); ?>'></div>
